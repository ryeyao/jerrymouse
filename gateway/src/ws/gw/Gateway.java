...
//            jo.add("handlers", new GsonBuilder().create().toJsonTree(hdlrs));
            ...
            ResourceDef2Json.writeJson(RES_DEF_DIR + File.separator + "Device." + localid + ".json", jo);
        }
