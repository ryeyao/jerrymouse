...
package cn.iie.gateway.manager.util.modeler;
...
public class BaseModelMBean implements DynamicMBean, MBeanRegistration, ModelMBeanNotificationBroadcaster {
    private static final Logger log = LogManager.getLogger(BaseModelMBean.class);
     ...
     *
     * @exception javax.management.AttributeNotFoundException if this attribute is not
     *  supported by this MBean
     * @exception javax.management.MBeanException if the initializer of an object
     *  throws an exception
     * @exception javax.management.ReflectionException if a Java reflection exception
...
//        }
     ...
     *  cannot be found
     * @exception javax.management.modelmbean.InvalidTargetObjectTypeException if the managed resource
     *  object is of the wrong type
     * @exception javax.management.MBeanException if the initializer of the object throws
     *  an exception
     * @exception javax.management.RuntimeOperationsException if the managed resource or the
...
//        }
     ...
     *
     *
     * @exception javax.management.ListenerNotFoundException if this listener is not
     ...
     *  that will be passed
     *
     * @exception javax.management.MBeanException if an object initializer throws an
     *  exception
     * @exception javax.management.RuntimeOperationsException wraps IllegalArgumentException
