...
import cn.iie.gateway.manager.lifecycle.Globals;
import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;
import cn.iie.gateway.manager.lifecycle.LifecycleException;
import cn.iie.gateway.manager.util.modeler.Registry;
...
public abstract class LifecycleMBeanBase extends LifecycleBase
    ...
    private static Logger log = LogManager.getLogger(LifecycleMBeanBase.class);
     ...
     * {@link javax.management.ObjectName} that will be used to register this component.
     *
     * @return  The string representation of the key properties component of the
     *          desired {@link javax.management.ObjectName}
     */
     ...
     * components that don't implement {@link javax.management.MBeanRegistration} with
     * an MBean server.<br/>
     ...
     * {@link javax.management.MBeanServer} and/or {@link javax.management.ObjectName}.
     */
    @Override
