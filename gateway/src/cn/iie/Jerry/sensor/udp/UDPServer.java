package cn.iie.jerry.sensor.udp;
...
public class UDPServer implements Runnable{
    ...
    public void init() throws SocketException {
        logger.info("Initializing cn.iie.jerry.sensor.udp Server...");
...
//        sendBuffer = new byte[1024];
    ...
    @Override
    public void run() {
        logger.info("cn.iie.jerry.sensor.udp Server listening on port " + port);
        while(true) {
